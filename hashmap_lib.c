...
static uint64_t u64v(uint8_t (*p));
static uint64_t (*u64p(uint8_t (*p)));
...
static uint64_t shift_hash(_6e5d_hashmap_lib_Hashmap (*map),uint64_t hsh);
static void (*getEntry(_6e5d_hashmap_lib_Hashmap (*map),uint64_t hsh,void (*key)));
...
static void (*do_insert(_6e5d_hashmap_lib_Hashmap (*map),void (*key),bool overwrite));
...
void _6e5d_hashmap_lib_init(_6e5d_hashmap_lib_Hashmap (*map),size_t size_key,size_t size_value){
	...
	assert((buckets!=NULL));
	((*map)=((_6e5d_hashmap_lib_Hashmap ){.size_key=size_key,.size_value=size_value,.size_entry=size_entry,.len=0,.bitshift=1,.buckets=buckets,.hasher=_6e5d_hashmap_lib_fnv1a,.eq=_6e5d_hashmap_lib_memeq,}));
}
void _6e5d_hashmap_lib_initstr(_6e5d_hashmap_lib_Hashmap (*map),uint32_t size_value){
	...
	auto void (*buckets) = calloc(2,size_entry);
	assert((buckets!=NULL));
	((*map)=((_6e5d_hashmap_lib_Hashmap ){.size_key=size_key,.size_value=size_value,.size_entry=size_entry,.len=0,.bitshift=1,.buckets=buckets,.hasher=_6e5d_hashmap_lib_fnv1astr,.eq=_6e5d_hashmap_lib_streq,}));
}
void _6e5d_hashmap_lib_deinit(_6e5d_hashmap_lib_Hashmap (*map)){
	free((map->buckets));
}
...
void (*_6e5d_hashmap_lib_getk(_6e5d_hashmap_lib_Hashmap (*map),void (*key))){
	auto uint64_t hsh = _6e5d_hashmap_lib_hash(map,key,(map->size_key));
...
void (*_6e5d_hashmap_lib_get(_6e5d_hashmap_lib_Hashmap (*map),void (*key))){
	auto uint8_t (*p) = _6e5d_hashmap_lib_getk(map,key);
	if((NULL==p)){
		return NULL;
	};
...
bool _6e5d_hashmap_lib_contains(_6e5d_hashmap_lib_Hashmap (*map),void (*key)){
	auto void (*ret) = _6e5d_hashmap_lib_get(map,key);
	return (NULL!=ret);
}
void _6e5d_hashmap_lib_debug(_6e5d_hashmap_lib_Hashmap (*map)){
...
static void (*do_insert(_6e5d_hashmap_lib_Hashmap (*map),void (*key),bool overwrite)){
	_6e5d_hashmap_lib_reserve(map,1);
	auto uint64_t hsh = _6e5d_hashmap_lib_hash(map,key,(map->size_key));
	auto uint8_t (*p) = getEntry(map,hsh,key);
...
void _6e5d_hashmap_lib_reserve(_6e5d_hashmap_lib_Hashmap (*map),size_t upcoming){
	...
	if((bitshift!=(map->bitshift))){
		_6e5d_hashmap_lib_resize(map,bitshift);
	};
}
void _6e5d_hashmap_lib_insertv(_6e5d_hashmap_lib_Hashmap (*map),void (*key),void (*value)){
...
_6e5d_hashmap_lib_Iter _6e5d_hashmap_lib_iter(_6e5d_hashmap_lib_Hashmap (*p)){
	...
	auto _6e5d_hashmap_lib_Iter it = {.entry=entry,.end=(entry+((p->size_entry)*bucket_len)),};
	return it;
}
void _6e5d_hashmap_lib_clear(_6e5d_hashmap_lib_Hashmap (*p)){
