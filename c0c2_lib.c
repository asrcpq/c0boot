...
_6e5d_c2r_lib_Object (*_6e5d_c1bytes_lib_ledump(_6e5d_c2r_lib_Object (*v),_6e5d_c2r_lib_Object (*buf)));
_6e5d_c2r_lib_Object (*_6e5d_c1bytes_lib_n2h(_6e5d_c2r_lib_Object (*n)));
_6e5d_c2r_lib_Object (*_6e5d_c1bytes_lib_hexdump(_6e5d_c2r_lib_Object (*b)));
...
static _6e5d_c2r_lib_Object (*decl(_6e5d_c2r_lib_Object (*ty),_6e5d_c2r_lib_Object (*v))){
	...
	if(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_ge(_6e5d_c2prim_lib_fromU64(1),_6e5d_c2prim_lib_length(ty)))){
		_6e5d_c2prim_lib_printobj(stderr,_6e5d_c2prim_lib_fromBuf("shortdecl",9));
		fprintf(stderr," ");
	...
	if(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_eq(kind,_6e5d_c2prim_lib_fromBuf("Ptr",3)))){
		...
		if(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_eq(_6e5d_c2prim_lib_fromU64(3),_6e5d_c2prim_lib_length(ty)))){
			if(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_lnot(_6e5d_c2prim_lib_fromBool((5==_6e5d_c2prim_lib_tid(_6e5d_c2prim_lib_getItem(ty,_6e5d_c2prim_lib_fromU64(2)))))))){
				_6e5d_c2prim_lib_printobj(stderr,_6e5d_c2prim_lib_fromBuf("notbytes",8));
				fprintf(stderr," ");
				_6e5d_c2prim_lib_printobj(stderr,ty);
				_6e5d_c2prim_lib_printobj(stderr,_6e5d_c2prim_lib_fromBuf("""\x0a""",1));
				_6e5d_c2prim_lib_abort();
...
static _6e5d_c2r_lib_Object (*writestr(_6e5d_c2r_lib_Object (*out),_6e5d_c2r_lib_Object (*s))){
	...
	while(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_fromU64(1))){
		...
		_6e5d_c2r_lib_check0(_6e5d_c1str_lib_push(out,_6e5d_c1bytes_lib_n2h(_6e5d_c2prim_lib_div(ch,_6e5d_c2prim_lib_fromU64(16)))));
		_6e5d_c2r_lib_check0(_6e5d_c1str_lib_push(out,_6e5d_c1bytes_lib_n2h(_6e5d_c2prim_lib_mod(ch,_6e5d_c2prim_lib_fromU64(16)))));
...
static _6e5d_c2r_lib_Object (*translateFn(_6e5d_c2r_lib_Object (*l),_6e5d_c2r_lib_Object (*deconly),_6e5d_c2r_lib_Object (*out))){
	...
	while(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_fromU64(1))){
		...
		if(_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_fromBool((_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_lnot(_6e5d_c2prim_lib_fromBool((6==_6e5d_c2prim_lib_tid(binding)))))||_6e5d_c2prim_lib_toBool(_6e5d_c2prim_lib_ne(_6e5d_c2prim_lib_fromU64(2),_6e5d_c2prim_lib_length(binding))))))){
			_6e5d_c2prim_lib_printobj(stderr,_6e5d_c2prim_lib_fromBuf("badargbind",10));
			fprintf(stderr," ");
			_6e5d_c2prim_lib_printobj(stderr,binding);
			_6e5d_c2prim_lib_printobj(stderr,_6e5d_c2prim_lib_fromBuf("""\x0a""",1));
			_6e5d_c2prim_lib_abort();
		};
